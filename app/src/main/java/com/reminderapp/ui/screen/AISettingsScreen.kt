...
val noApiProviders = listOf(
    NoApiProvider("deepseek", "DeepSeek", "https://platform.deepseek.com/api_keys", "注册即送 500 万 tokens", "https://api.deepseek.com/v1", "deepseek-chat"),
    NoApiProvider("qwen", "通义千问", "https://dashscope.console.aliyun.com/apiKey", "开通即送 100 万 tokens", "https://dashscope.aliyuncs.com/compatible-mode/v1", "qwen-plus"),
    NoApiProvider("doubao", "豆包", "https://console.volcengine.com/ark/region:ark+cn-beijing/apiKey", "注册即送 50 万 tokens", "https://ark.cn-beijing.volces.com/api/v3", "doubao-lite-32k")
)
